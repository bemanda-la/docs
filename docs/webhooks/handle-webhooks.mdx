...
### **Descripción**
Registra un nuevo webhook especificando la URL de destino, los eventos a los que deseas suscribirte y un secreto para la validación de firmas. [Validación de firmas](/docs/webhooks/handle-webhooks)
