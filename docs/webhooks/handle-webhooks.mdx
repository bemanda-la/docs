...
### **Ejemplo de solicitud**
```http
GET /webhooks/d91cfd6c-cb8f-40df-8f3f-142872df2122 HTTP/1.1
Host: api.example.com
Authorization: Bearer <token>
```
...
### **Ejemplo de solicitud**
```http
POST /webhooks/be19aa21-95e8-4398-a856-e77f211a5cc5/retry-challenge HTTP/1.1
Host: api.example.com
Authorization: Bearer <token>
```
...
### **Ejemplo de solicitud**
```http
POST /webhooks/be19aa21-95e8-4398-a856-e77f211a5cc5/resume HTTP/1.1
Host: api.example.com
Authorization: Bearer <token>
```
...
### **Ejemplo de solicitud**
```http
DELETE /webhooks/f7a31ccd-c5d4-4c99-b00a-3c303180dd65 HTTP/1.1
Host: api.example.com
Authorization: Bearer <token>
```
